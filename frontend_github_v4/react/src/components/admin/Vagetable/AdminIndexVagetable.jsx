...
export const fruitsLoader = async () => {
  ...
  export const AdminDeleteVagetableAction = async ({ request }) => {
    ...
    return Swal.fire({
        ...
        if (result.isConfirmed) {
           return axiosClient.delete(`admin/vagetable/delete/${id}`).then(({data})=>{
            console.log(data)
                return toast.fire({
                    title: 'Deleted!',
                    text: data,
...
export default function AdminIndexVagetable (){
