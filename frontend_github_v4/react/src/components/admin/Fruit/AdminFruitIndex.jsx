...
export const fruitsLoader = async () => {
  ...
  export const AdminDeleteFruitAction = async ({ request }) => {
    ...
    return Swal.fire({
        ...
        if (result.isConfirmed) {
           return axiosClient.delete(`admin/fruit/delete/${id}`).then(({data})=>{
            console.log(data)
                return toast.fire({
                    title: 'Deleted!',
                    text: data,
...
export default function AdminFruitIndex (){
    ...
    return(
        <div className="flex flex-col">
            <div className="my-5">
            <Link to="create" className="m-5  p-3 text-white hover:bg-green-600 bg-green-500">Add Fruit</Link>
            </div>
