...
class FruitFactsSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        foreach(Fruits::all() as $fruit){
            ...
            FruitsBenefits::create([
                'fruit_id'=>$fruit->id,
                'name'=>'Impressive Health Benefits of '.$fruit->name,
            ...
            FruitsBenefits::create([
                'fruit_id'=>$fruit->id,
                'name'=>'May support weight loss of '.$fruit->name,
            ...
            FruitsBenefits::create([
                'fruit_id'=>$fruit->id,
                'name'=>'Could be good for your heart of '.$fruit->name,
            ...
            FruitsBenefits::create([
                'fruit_id'=>$fruit->id,
                'name'=>'Linked to a lower risk of diabetes of '.$fruit->name,
            ...
            FruitsBenefits::create([
                'fruit_id'=>$fruit->id,
                'name'=>'May promote gut health of '.$fruit->name,
